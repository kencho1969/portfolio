...
<head>
<meta charset="utf-8">
<title>○×寿司 - 店舗削除確認</title>
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" integrity="sha384-JcKb8q3iqJ61gNV9KGb8thSsNjpSL0n8PARn9HuZOnIxN0hoP+VmmDGMN5t9UJ0Z" crossorigin="anonymous">
<link rel="stylesheet" href="../default.css">
</head>
<body>
<h2>店舗情報削除</h2>
<p><b><%=Sanitize.forHtml(store)%></b>の店舗情報を削除します。<br>この操作は復元できませんが本当によろしいですか？</p>
<form action="deletestore.jsp" method="POST">
<input type='text' name='store' value='<%=Sanitize.forHtml(store)%>' hidden>
<input type='submit' value='削除する'>
<button type="button" onclick="location.href='stores.jsp'">キャンセル</button>
</form>
