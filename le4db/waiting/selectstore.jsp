	...
	try(Connection conn = DriverManager.getConnection("jdbc:sqlite:" + dbfile)){
		...
		try (ResultSet rs = st.executeQuery()){
			while (rs.next()) {
                ...
                out.println("<form action='register.jsp' method='GET'><input type='text' name='store' value="+ Sanitize.forHtml(name) +" hidden><input type='submit' value='選択'></form>");
				out.println("</div>");
			}
		}
	} catch (Exception e) {
